...
C-----------------------------------------------------------------------
 ...
 55   FORMAT (I7,1X,F4.0,3(1X,F5.0),2(1X,A5),1X,F5.0)
 60   FORMAT (I7,1X,I8,1X,A5,1X,F5.0,4X,I2)
...
C-----------------------------------------------------------------------
 ...
 60   FORMAT (I7,1X,I5,1X,A5,1X,F5.0,3(1X,F5.0),2(1X,F5.0),1X,A5)
...
C-----------------------------------------------------------------------
 ...
 60   FORMAT (I7,1X,I5,1X,A5,1X,A5,6(1X,F5.0),1X,A5)
...
C-----------------------------------------------------------------------
 ...
 60   FORMAT (I8,I5,3(1X,A5),2(1X,F5.0),6X,F5.0,F5.0) !editted to read forage variables (Diego-2/14/2017)
...
C-----------------------------------------------------------------------
 ...
 55   FORMAT (I7,1X,A2,1X,A6,1X,A16)
